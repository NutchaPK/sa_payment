...
// The BillStatusFunc type is an adapter to allow the use of ordinary
// function as BillStatus mutator.
type BillStatusFunc func(context.Context, *ent.BillStatusMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f BillStatusFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.BillStatusMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.BillStatusMutation", m)
	}
	return f(ctx, mv)
}
...
// The PaymentStatusFunc type is an adapter to allow the use of ordinary
// function as PaymentStatus mutator.
type PaymentStatusFunc func(context.Context, *ent.PaymentStatusMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f PaymentStatusFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.PaymentStatusMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.PaymentStatusMutation", m)
	}
	return f(ctx, mv)
}
