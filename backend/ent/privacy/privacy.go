...
// The BillStatusQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type BillStatusQueryRuleFunc func(context.Context, *ent.BillStatusQuery) error

// EvalQuery return f(ctx, q).
func (f BillStatusQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.BillStatusQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.BillStatusQuery", q)
}

// The BillStatusMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type BillStatusMutationRuleFunc func(context.Context, *ent.BillStatusMutation) error

// EvalMutation calls f(ctx, m).
func (f BillStatusMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.BillStatusMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.BillStatusMutation", m)
}
...
// The PaymentStatusQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type PaymentStatusQueryRuleFunc func(context.Context, *ent.PaymentStatusQuery) error

// EvalQuery return f(ctx, q).
func (f PaymentStatusQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.PaymentStatusQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.PaymentStatusQuery", q)
}

// The PaymentStatusMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type PaymentStatusMutationRuleFunc func(context.Context, *ent.PaymentStatusMutation) error

// EvalMutation calls f(ctx, m).
func (f PaymentStatusMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.PaymentStatusMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.PaymentStatusMutation", m)
}
